    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header bg-success text-white">
                <h4><i class="bi bi-gift"></i> Enregistrer un don</h4>
            </div>
            <div class="card-body">
                <form id="formDon">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="donateur" name="donateur" 
                               placeholder="Optionnel - Laissez vide pour 'Anonyme'">
                    </div>

                    <div class="mb-3">
                        <label for="type_besoin_id" class="form-label">Type de don *</label>
                    ...
                    <div class="mb-3" id="valeurEstimee" style="display: none;">
                        <div class="alert alert-success">
                            <strong>Valeur estimée du don:</strong> <span id="valeurCalculee">0</span> Ar
                        </div>
                    </div>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <p>Les dons seront automatiquement distribués aux villes ayant des besoins lors de l'exécution du dispatch.</p>
                <p>Le dispatch se fait par ordre chronologique (date de saisie des besoins et des dons).</p>
            </div>
        </div>
    </div>
</div>
